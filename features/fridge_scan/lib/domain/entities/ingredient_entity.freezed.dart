...
mixin _$IngredientEntity {
 ...
 String? get id; String? get scanId; String? get name; String? get quantity; String? get unit; String? get category;
...
@override
String toString() {
  return 'IngredientEntity(id: $id, scanId: $scanId, name: $name, quantity: $quantity, unit: $unit, category: $category)';
}
...
@useResult
$Res call({
 String? id, String? scanId, String? name, String? quantity, String? unit, String? category
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String? scanId,  String? name,  String? quantity,  String? unit,  String? category)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IngredientEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String? scanId,  String? name,  String? quantity,  String? unit,  String? category)  $default,) {final _that = this;
switch (_that) {
case _IngredientEntity():
return $default(_that.id,_that.scanId,_that.name,_that.quantity,_that.unit,_that.category);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String? scanId,  String? name,  String? quantity,  String? unit,  String? category)?  $default,) {final _that = this;
switch (_that) {
case _IngredientEntity() when $default != null:
return $default(_that.id,_that.scanId,_that.name,_that.quantity,_that.unit,_that.category);case _:
  return null;
...
class _IngredientEntity implements IngredientEntity {
   _IngredientEntity({this.id, this.scanId, this.name, this.quantity, this.unit, this.category});
