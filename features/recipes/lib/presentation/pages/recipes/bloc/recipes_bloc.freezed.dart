...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RecipesEvent);
}
...
/// @nodoc
class $RecipesEventCopyWith<$Res>  {
$RecipesEventCopyWith(RecipesEvent _, $Res Function(RecipesEvent) __);
}


/// Adds pattern-matching-related methods to [RecipesEvent].
extension RecipesEventPatterns on RecipesEvent {
...
class _Started implements RecipesEvent {
  const _Started();
...
class _RecipesState implements RecipesState {
  const _RecipesState();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RecipesState);
}
