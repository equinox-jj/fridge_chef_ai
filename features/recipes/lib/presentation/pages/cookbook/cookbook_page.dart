...
class _CookbookPageState extends State<CookbookPage> {
  ...
  void _startScan() => context.read<AppNavigator>().goToHome();
                ...
                children: <Widget>[
                  if (isOffline)
                    const Padding(
                      ...
                      child: AppInfoBanner(
                        message:
                            "You're offline — timers and saved recipes still work.",
  ...
  Widget build(BuildContext context) {
    switch (state.status) {
      ...
      case BlocStatus.loading:
        ...
        if (state.recipes.isEmpty) return const AppLoadingIndicator();
      ...
      case BlocStatus.empty:
        return Center(
          child: AppEmptyState(
            ...
            message:
                'Save a recipe and it lands here — ready to cook, even offline.',
      ...
      case BlocStatus.error:
        return Center(
          child: AppEmptyState(
            ...
            onAction: () => context.read<CookbookBloc>().add(
