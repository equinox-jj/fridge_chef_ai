...
_RecipeStepModel _$RecipeStepModelFromJson(Map<String, dynamic> json) => _RecipeStepModel(
  stepNumber: (json['step_number'] as num?)?.toInt(),
  instruction: json['instruction'] as String?,
  timerSeconds: (json['timer_seconds'] as num?)?.toInt(),
);

Map<String, dynamic> _$RecipeStepModelToJson(_RecipeStepModel instance) => <String, dynamic>{
