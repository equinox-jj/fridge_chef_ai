  ...
  _TagColors _colorsFor(AppTagTone tone) {
    switch (tone) {
      case AppTagTone.green:
        return const _TagColors(AppColors.successTint, AppPalette.green100, AppColors.primaryText);
      case AppTagTone.purple:
        return const _TagColors(AppColors.aiTint, AppPalette.purple100, AppColors.aiText);
      case AppTagTone.amber:
        return const _TagColors(AppColors.actionTint, AppPalette.amber100, AppColors.actionText);
      case AppTagTone.coral:
        return const _TagColors(AppColors.dangerTint, AppPalette.coral100, AppColors.dangerText);
      case AppTagTone.blue:
        return const _TagColors(AppColors.infoTint, AppPalette.blue100, AppColors.infoText);
